...
> **building**). N0 gate is clear. Deliver `scripts/dogfood_cycle1.py`,
> report under `docs/dogfood/cycle1/`, and CI pin via `tests/test_dogfood.py`
> — same honesty bar as cycles 2–4 (defects recorded; no settlement fiction).
>
> **G10:** never dual-reopen **N1.3**, **P7**, **N0**, **N1.1**, **N1.2**,
> **M7**, or **O.8**. Park **G9** design (RPC) — not dual.
>
...
> Merkle/anchors; G9 chain reconcile; settlements **0**.
>
...
> Claim **building cycle-1**. Settlements: **0**. Prior plane `#39` / `330bf68`; P7
