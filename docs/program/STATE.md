...
> `#78` / `#81` / `#82` / `#84` / `#85` / `#86` / `#88` / `#89`. Settlements **0**. Gap G9
> **still open**. Not PyPI.
>
...
> **Tip of `origin/main`:** `acc8f2d` (PR **#89** pruner light noop_idle tip-align).
> Prior: `#88` / `abbfb40` post-merge tip-align; `#86` / `d4769ca` pruner ship evidence; `#85` / `232efac`;
> `#84` / `398e2ac`; `#82` / `48d7703`; free closeout **`2876f0a`** (#78).
