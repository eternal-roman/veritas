...
> `#76`; P7-C `#69` / `e7f674b`; v0.8.1 `#62`; N1.5 `#60`. Closeouts `#78`/`#81`.
...
> **Tip of `origin/main`:** `458c36a` (PR **#81** G10 survival-reputation harvest).
> Prior free closeout **`2876f0a`** (#78). Product A26/A27 **`ab728a6`** (#75);
> N0-residue **`1c56a0b`** (#77). Claim **free**. Settlements: **0**. Gap G9 open.
