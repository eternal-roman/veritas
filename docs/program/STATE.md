...
> `#78` / `#81` / `#82` / `#84` / `#85` / `#86` / `#89` / `#91` / `#93`. Settlements **0**. Gap G9
> **still open**. Not PyPI.
>
...
> **Tip of `origin/main`:** `f87a467` (PR **#93** steward restock post-#91).
> Prior: `#91` / `03d7401`; `#89` / `acc8f2d` pruner light noop_idle; `#88` / `abbfb40`;
> `#86` / `d4769ca`; free closeout **`2876f0a`** (#78).
