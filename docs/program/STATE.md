...
>
> **On main (do not re-open):** v0.8.1 `#62` / `070d4c4` + closeout `#63` /
> `17222c5`; N1.5 `#60` / `e089f86`; v0.8.0; N1.4; cycle-5; G9-design; P7
> product; N0–N1.3; cycle-1.
>
...
> full pool → registered 503 shed. Free OK with shed. One engine. Settlements **0**.
>
> **G10:** never dual live-RPC G9 under this claim. Gap G9 **still open**.
>
...
> **Tip of `origin/main`:** `17222c5` (#63). Product N1.5 @ `e089f86`; v0.8.1 @ `070d4c4`.
> Claim **building P7-C**. Settlements: **0**. Gap G9 open.
>
> **v0.8.1 landed on main @ `070d4c4` (PR #62).** `__version__` = 0.8.1.
> **N1.5 landed on main @ `e089f86` (PR #60).** Inclusion proof on observe.
>
