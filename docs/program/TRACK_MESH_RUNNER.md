...
| Overseer | Accept scale rules / park tracks | Running kernel |
| Optimizer | May adopt mesh LEARN into CONTINUOUS cadence | Dual product bets |
...
After every **5** mesh cycles (or on demand / Optimizer tick).

```
PROPERTY: mesh runner unblocks zero-progress cooperative tracks
EVIDENCE LEVEL: L1
NOT PROVEN: continuous hosting of kernel
```
