...
**G10:** Claim **free**. Open product PRs: **none**. Settlements: testnet **2** (self-dogfood); unsolicited **0**; mainnet **0**. Not on PyPI. #131 is evolver WATCH fuel — not demand proof. #129 measures landmass — does **not** invent existence or n=3.
