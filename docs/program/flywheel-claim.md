...
- **status:** building
- **updated:** 2026-08-08T20:37:00Z
- **last_merged:** N1.3 #41 @ `622429c`; docs #39 @ `330bf68`; P7 #38 @ `4697c8d`; N1.2 #34 @ `32d1054`; N1.1 #33 @ `db04ae2`; N0 @ `4cd2d0c`
- **next_micro:** Cold autonomous install dogfood — `scripts/dogfood_cycle1.py`, `docs/dogfood/cycle1/`, CI pin in `tests/test_dogfood.py`. Park G9; do not re-open N1.3/P7/N0/N1/M7. Settlements **0**.
...
| P7 post-merge closeout | `330bf68` / #39 |
| **N1.3 portable EvidencePack** | **`622429c` / #41** |

**G10:** Claim **building cycle-1**. Open product PRs: **none** at assign. Settlements: **0**.
